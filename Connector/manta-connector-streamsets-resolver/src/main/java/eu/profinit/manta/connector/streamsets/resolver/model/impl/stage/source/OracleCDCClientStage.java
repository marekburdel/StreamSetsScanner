 ...
 * @author mburdel
 */
public class OracleCDCClientStage extends Stage implements IOracleCDCClientStage {
    ...
    public OracleCDCClientStage(String instanceName, String stageName, IStageUIInfo stageUIInfo,
