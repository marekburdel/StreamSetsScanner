...
import eu.profinit.manta.connector.streamsets.resolver.model.impl.stage.source.PostgreSQLCDCClientStage;
 ...
 * @author mburdel
 */
public class PostgreSQLCDCClientProcessor extends AbstractStageProcessor {
    ...
    @Override protected void processConfiguration(JSONArray jsonConfiguration) {
        for (Object jsonObject : jsonConfiguration) {
            ...
            case "hikariConf.username":
                ...
                break;
            case "postgresCDCConfigBean.baseConfigBean.schemaTableConfigs":
    ...
    @Override protected IStage processStage(String instanceName, String stageName, IStageUIInfo stageUIInfo,
        ...
        return new PostgreSQLCDCClientStage(instanceName, stageName, stageUIInfo, inputLanes, outputLanes, eventLanes,
